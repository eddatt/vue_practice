<template lang="pug">
  <v-app>
      ...
      <v-expansion-panel>
        <v-expansion-panel-content class="primary white--text" text-align-left>
          <template v-slot:header>
            <span class="font-weight-bold headline">部门</span>
            <Ipopup/>
          </template>
          <v-list class="py-0">
    ...
    <v-expansion-panel>
        <v-expansion-panel-content class="primary white--text" text-align-left>
          <template v-slot:header>
            <span class="font-weight-bold headline">用户管理</span>
           
          </template>
          <v-list class="py-0">
            <v-list-tile class="primary" router to="/admin/home/search">
              <v-list-tile-content>
                    <v-list-tile-title class="white--text mx-3">搜寻用户</v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
            <v-list-tile class="primary" router to="/admin/home/newuser">
              <v-list-tile-content>
                    <v-list-tile-title class="white--text mx-3">新增用户</v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
          </v-list>
        </v-expansion-panel-content>
    ...
    <v-expansion-panel>
        <v-expansion-panel-content class="primary white--text" text-align-left>
          <template v-slot:header>
            <span class="font-weight-bold headline">统计信息</span>
           
          </template>
          <v-list class="py-0">
            <v-list-tile class="primary" router to="/admin/home/chart">
              <v-list-tile-content>
                    <v-list-tile-title class="white--text mx-3">图表</v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
          </v-list>
        </v-expansion-panel-content>
