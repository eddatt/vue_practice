<template>
        <v-dialog max-width="1000px">
            <v-btn flat slot="activator" class="primary">部门
            ...
            <v-card>
                ...
                <v-card-text>
                    <v-form class="px-3" ref="form">
                        <v-text-field label="部门名称" v-model="classname" prepend-icon="folder"></v-text-field>
                        <v-textarea label="部门简介" v-model="content" prepend-icon="edit"></v-textarea>
                        <v-spacer></v-spacer>
