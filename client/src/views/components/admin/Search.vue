    ...
    <v-card>
        <v-card-text>
            <v-form class="px-3" ref="form">
                <span class="">通过学号查找用户</span>
                <v-text-field label="学号" v-model="stu_id" prepend-icon="person"></v-text-field>
                
                <v-spacer></v-spacer>
                <v-btn flat center class="primary mt-0 mt-3" @click="search_stuid()">查找</v-btn>
            </v-form>
        </v-card-text>
