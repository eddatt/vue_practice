  ...
  <v-app>
      ...
      <v-expansion-panel>
          <v-expansion-panel-content class="primary white--text" text-align-left>
            <template v-slot:header>
              ...
              <span class="font-weight-bold headline">信息管理</span>
            </template>
            <v-list class="py-0">
              <v-list-tile class="primary" router to="/user/home/profile">
                <v-list-tile-content>
                      <v-list-tile-title class="white--text mx-3">用户信息</v-list-tile-title>
                </v-list-tile-content>
              </v-list-tile>
              <v-list-tile class="primary" router to="/user/home/EditProfile">
                <v-list-tile-content>
                      <v-list-tile-title class="white--text mx-3">信息修改</v-list-tile-title>
                </v-list-tile-content>
              </v-list-tile>
            </v-list>
    ...
    <v-expansion-panel class="py-0">
      <v-expansion-panel-content class="primary white--text" text-align-left>
        <template v-slot:header>
          //- <v-icon class="white--text" lg left>dashboard</v-icon>
          <span class="font-weight-bold headline">我的工作</span>
        </template>
        <v-list class="py-0">
